...
# USER INPUTS
#######################################################################
inputFile = '/mnt/NAS-Drive/Utkarsh-Share/ShuFen/NanoRodAttachment/DiffusionConstant/with linker/with linker-crop.avi'
outputFile = '/mnt/NAS-Drive/Utkarsh-Share/ShuFen/NanoRodAttachment/DiffusionConstant/with linker/with linker-crop.h5'
inputDir = '/mnt/NAS-Drive/Utkarsh-Share/ShuFen/NanoRodAttachment/DiffusionConstant/with linker'
outputDir = '/mnt/NAS-Drive/Utkarsh-Share/ShuFen/NanoRodAttachment/DiffusionConstant/output'
pixInNM = 1391.21/1072
fps = 10
microscope = 'JOEL2010' #'JOEL2010','T12'
camera = 'Orius' #'Orius', 'One-view'
owner = 'Shu Fen'
